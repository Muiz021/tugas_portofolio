    <!-- Modal -->
    <div class="modal fade" id="get-{{$edit->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data" action="{{url('/edit-project/'.$edit->id)}}" method="POST">
                    @csrf
                    <div class="modal-body">
                     <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <textarea class="form-control" rows="3" name="deskripsi" style="height: 71px; resize:none;">{{$edit->deskripsi}}</textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
