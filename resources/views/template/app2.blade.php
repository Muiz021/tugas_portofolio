...
<body>
    ...
    <!-- ======= Hero Section ======= -->
    <div id="hero" class="hero route bg-image" style="background-image: url({{ asset('assetsTemplate2/img/hero-bg.jpg') }})">
                        ...
                        <div class="box-shadow-full">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="skill-mf">
                                        <p><span class="title-s">TTL: </span> <span>{{ Auth::user()->portofolio->tempat }}, {{ Auth::user()->portofolio->tanggal }}</span></p>
